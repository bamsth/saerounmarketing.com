      ...
      <main className="min-h-screen bg-slate-950 text-white pt-16">
        <div className="max-w-3xl mx-auto px-6 py-20">
          ...
          <div className="flex items-center gap-6 mb-16">
            ...
            />
            <div>
              <h1 className="text-3xl font-black text-white">김범수</h1>
              <p className="text-blue-400 mt-1">수의사 · 새로운마케팅 대표</p>
          ...
          {/* 핵심 철학 */}
          <blockquote className="border-l-4 border-blue-500 pl-6 mb-16">
            <p className="text-2xl md:text-3xl font-black text-white leading-tight">
              &ldquo;전문성을 키우고 알리는 것.
              <br />
              <span className="text-blue-400">이것이 유일한 생존 전략입니다.&rdquo;</span>
            </p>
          </blockquote>
